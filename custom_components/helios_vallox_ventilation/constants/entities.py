...
SENSOR_ENTITIES = [
    ...
    {"key": "post_heating_target", "unit": "°C", "device_class": "temperature", "state_class": None, "icon": "mdi:thermometer"},
    ...
    {"key": "analog_input", "unit": None, "device_class": None, "state_class": None, "icon": "mdi:current-dc", "entity_category": "diagnostic", "enabled_default": False},
...
BINARY_SENSOR_ENTITIES = [
    ...
    {"key": "bypass_damper_position", "device_class": None, "icon": "mdi:valve"},
    {"key": "fault_relay", "device_class": None, "icon": "mdi:electric-switch"},
    {"key": "preheating_on", "device_class": None, "icon": "mdi:heating-coil"},
    {"key": "external_boost_switch", "device_class": None, "icon": "mdi:toggle-switch"},
...
NUMBER_ENTITIES = [
    ...
    {"key": "preheat_setpoint", "unit": "°C", "min": -10, "max": 10, "step": 1, "mode": "box", "icon": "mdi:thermometer", "description": "Pre-heating activation temperature", "factory_setting": -3, "entity_category": "config"},
    {"key": "post_heating_setpoint", "unit": "°C", "min": 10, "max": 30, "step": 1, "mode": "box", "icon": "mdi:thermometer", "description": "User-configured post-heating setpoint", "factory_setting": None, "entity_category": "config"},
