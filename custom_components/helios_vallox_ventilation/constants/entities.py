...
SENSOR_ENTITIES = [
    ...
    {"key": "co2_setting_lower_byte", "unit": None, "device_class": None, "state_class": None, "icon": "mdi:molecule-co2", "enabled_default": False},
...
BINARY_SENSOR_ENTITIES = [
    ...
    {"key": "co2_sensor1_present", "device_class": "connectivity", "icon": "mdi:molecule-co2", "enabled_default": False},
    {"key": "co2_sensor2_present", "device_class": "connectivity", "icon": "mdi:molecule-co2", "enabled_default": False},
    {"key": "co2_sensor3_present", "device_class": "connectivity", "icon": "mdi:molecule-co2", "enabled_default": False},
    {"key": "co2_sensor4_present", "device_class": "connectivity", "icon": "mdi:molecule-co2", "enabled_default": False},
    {"key": "co2_sensor5_present", "device_class": "connectivity", "icon": "mdi:molecule-co2", "enabled_default": False},
